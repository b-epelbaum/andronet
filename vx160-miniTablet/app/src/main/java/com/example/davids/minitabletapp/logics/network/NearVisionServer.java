...
public class NearVisionServer extends NanoHTTPD {
    ...
    public String generateResponse(Consts.L40Cmd selectedTest) {
        ...
        String res = null;
        Gson gson = new GsonBuilder().registerTypeAdapter(ServerResponse.class,
                new ResponseJsonSerializer()).setPrettyPrinting().create();
        ...
        switch (selectedTest.mTestId) {
            ...
            case 502:
                ...
                firstRow = NearVisionApplication.getTextArrayList().get(
                        NearVisionApplication.getCurrentTextParagraph()).getText();
                //secondRow = _langParagraphs.get(_currentTextParagraph);

                ac1 = NearVisionApplication.getTextArrayList().get(
                        NearVisionApplication.getCurrentTextParagraph()).getTextHeaderWithoutSpaces();
